  ...
  const diaryCardSectionMarkUp = !props.diary.edit ? (
    ...
    <Card.Section>
      <Form onSubmit={ handleSubmit }>
        <FormLayout>
          <TextField value={ title } onChange={ handleTitleChange } placeholder="Title"/>
          <TextField value={ description } multiline={ 10 } onChange={ handleDescriptionChange } placeholder="Description"/>
        </FormLayout>
        <ButtonGroup>
